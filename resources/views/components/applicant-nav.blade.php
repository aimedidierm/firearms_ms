<div class="col-md-3 left_col">
    <div class="left_col scroll-view">
        <div class="navbar nav_title" style="border: 0;">
            <a href="/applicant" class="site_title"><i class="fa fa-database"></i> <span>Firearms MS
                    system</span></a>
        </div>
        ...
        <div class="profile clearfix">
            ...
            <div class="profile_info">
                <span>Welcome, Applicant</span>
                <h2>{{Auth::guard("applicant")->user()->names}}</h2>
            </div>
        </div>
            ...
            <ul class=" navbar-right">
                <li class="nav-item dropdown open" style="padding-left: 15px;">
                    ...
                    <div class="dropdown-menu dropdown-usermenu pull-right" aria-labelledby="navbarDropdown">
                        <a class="dropdown-item" href="/applicant"> Profile</a>
                        <a class="dropdown-item" href="/applicant">
                            <span>Settings</span>
                        </a>
